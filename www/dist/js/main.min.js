...
$(document).ready(function(){function o(){$("html").removeClass("no-js"),$("html").removeAttr("class"),console.log("Prêt à démarrer !")}$('[data-toggle="popover"]').popover(),$('[data-toggle="tooltip"]').tooltip(),o()});